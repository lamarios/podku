...
class SearchApi {
  ...
  Future<Response<List<SearchResult>>> search({ 
    ...
    List<SearchResult>? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<List<SearchResult>, SearchResult>(rawData, 'List<SearchResult>', growable: true);
    ...
    return Response<List<SearchResult>>(
      data: _responseData,
