...
class EpisodesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Episode] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Episode>> getEpisode({ 
    required String id,
    ...
    final _path = r'/api/episodes/{id}'.replaceAll('{' r'id' '}', id.toString());
    ...
    Episode? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<Episode, Episode>(rawData, 'Episode', growable: true);
...
_responseData = rawData == null ? null : deserialize<List<Episode>, Episode>(rawData, 'List<Episode>', growable: true);
  ...
  Future<Response<List<Episode>>> search2({ 
    ...
    final _path = r'/api/episodes/search';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<List<Episode>, Episode>(rawData, 'List<Episode>', growable: true);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> setProgress({ 
    ...
    final _path = r'/api/episodes/setProgress';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = jsonEncode(playbackProgress);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> startPlayback({ 
    required PlaybackProgress playbackProgress,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/episodes/startPlayback';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<bool>> updateProgresses({ 
    required Map<String, OfflineProgress> requestBody,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/episodes/setProgressesBatch';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
