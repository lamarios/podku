...
- Android auto support (only when downloading the app from the Play Store)

## Screenshots

### Mobile
![1_en-US.png](./images/phoneScreenshots/1_en-US.png)
![2_en-US.png](./images/phoneScreenshots/2_en-US.png)
![3_en-US.png](./images/phoneScreenshots/3_en-US.png)
![4_en-US.png](./images/phoneScreenshots/4_en-US.png)


### Tablet / Desk
![1_en-US.png](./images/sevenInchScreenshots/1_en-US.png)
![2_en-US.png](./images/sevenInchScreenshots/2_en-US.png)
