...
public class WebSocketSessionManager {
  ...
  /**
   * Constructs the session manager with required repository and transaction manager.
   *
   * @param episodeRepository episode repository for playback progress
   ...
   *
   * @param session newly connected WebSocket session
   *     <p>javadoc generated by AI
   */
  ...
  /**
   * Cleans up and removes a closed WebSocket session.
   *
  ...
  /**
   * Assembles a list of currently connected identified clients and the active player.
   *
   * @return ClientList snapshot
   *     <p>javadoc generated by AI
   */
  ...
  /**
   * Scheduled task that periodically broadcasts the client list to all open sessions.
   *
   * <p>javadoc generated by AI
   */
  @Scheduled(cron = "0,30 * * * * *")
  ...
  /**
   * Tests session liveness via ping or cleans up if pong timeout exceeded.
   *
  ...
  /**
   * Scheduled task to clean timed-out sessions and verify the active player.
   *
   * <p>javadoc generated by AI
   */
  ...
  /**
   * Broadcasts a typed message payload to all open client sessions.
   *
   * @param content payload object to serialize and send
  ...
  /**
   * Dispatches an incoming text message to the appropriate handler based on its type.
   *
  ...
  /**
   * Records pong timestamp and synchronizes player status.
   *
   * @param session responding session
   * @param status current player status from pong
   *     <p>javadoc generated by AI
   */
  ...
  /**
   * Sends a WebSocketMessage object to a target session.
   *
  ...
  /**
   * Sends a string message as a TextMessage to a target session.
   *
   * @param session target session
  ...
  /**
   * Handles player identification information sent by a client.
   *
  ...
  /**
   * Forwards a remote control command to the current player session.
   *
   * @param remoteCommand command message
   *     <p>javadoc generated by AI
   */
  ...
  /**
   * Looks up the WebSocket session belonging to the currently active player.
   *
  ...
  /**
   * Finds the WebSocket session associated with a specific client.
   *
  ...
  /**
   * Retrieves the client information associated with a session.
   *
   * @param session WebSocket session
   * @return optional WebsocketClient
   *     <p>javadoc generated by AI
   */
  ...
  /**
   * Cleans up disconnected session state and notifies peers if the active player disconnected.
   *
   * @param session session being removed
   * @throws IOException on error notifying clients
   *     <p>javadoc generated by AI
   */
  ...
  /**
   * Handles player status updates and broadcasts new playback state to other clients.
   *
   * @param session sender session
   * @param newPlayerStatus incoming player status
   * @throws IOException on error sending broadcast
   *     <p>javadoc generated by AI
   */
  ...
  /**
   * Serializes current player status into a TextMessage.
   *
