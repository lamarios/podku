...
public class DominantColorExtractor {
  /**
   * Extracts the dominant color hex string from a podcast's artwork.
   *
  ...
  /**
   * Downloads an image from the given URL and extracts its dominant Color.
   *
   * @param imageUrl image URL
  ...
  /**
   * Analyzes an image and determines the dominant Color through quantization and frequency
   * counting.
   *
  ...
  /**
   * Checks whether RGB components are too close to black or white.
   *
   * @param r red value
   * @param g green value
   * @param b blue value
   * @return true if near white or black
   *     <p>javadoc generated by AI
   */
  ...
  /**
   * Calculates the simple average Color across all non-transparent pixels in an image.
   *
   * @param image buffered image
  ...
  /**
   * Example main method for manual testing.
   *
   * @param args CLI args
   * @throws Exception on extraction error
   *     <p>javadoc generated by AI
   */
