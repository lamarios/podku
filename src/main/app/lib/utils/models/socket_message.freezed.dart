...
$PodkuSocketMessageCopyWith<PodkuSocketMessage> get copyWith => _$PodkuSocketMessageCopyWithImpl<PodkuSocketMessage>(this as PodkuSocketMessage, _$identity);

  /// Serializes this PodkuSocketMessage to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PodkuSocketMessage&&const DeepCollectionEquality().equals(other.message, message)&&(identical(other.type, type) || other.type == type));
}
...
@override
String toString() {
  return 'PodkuSocketMessage(message: $message, type: $type)';
}
...
/// @nodoc
abstract mixin class $PodkuSocketMessageCopyWith<$Res>  {
...
/// @nodoc
class _$PodkuSocketMessageCopyWithImpl<$Res>
    implements $PodkuSocketMessageCopyWith<$Res> {
  _$PodkuSocketMessageCopyWithImpl(this._self, this._then);

  final PodkuSocketMessage _self;
  final $Res Function(PodkuSocketMessage) _then;
...
/// Adds pattern-matching-related methods to [PodkuSocketMessage].
extension PodkuSocketMessagePatterns on PodkuSocketMessage {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PodkuSocketMessage value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PodkuSocketMessage value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PodkuSocketMessage value)?  $default,){
final _that = this;
switch (_that) {
case _PodkuSocketMessage() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$PodkuSocketMessageCopyWith<_PodkuSocketMessage> get copyWith => __$PodkuSocketMessageCopyWithImpl<_PodkuSocketMessage>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PodkuSocketMessageToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PodkuSocketMessage&&const DeepCollectionEquality().equals(other._message, _message)&&(identical(other.type, type) || other.type == type));
}
...
/// @nodoc
abstract mixin class _$PodkuSocketMessageCopyWith<$Res> implements $PodkuSocketMessageCopyWith<$Res> {
...
/// @nodoc
class __$PodkuSocketMessageCopyWithImpl<$Res>
    implements _$PodkuSocketMessageCopyWith<$Res> {
  __$PodkuSocketMessageCopyWithImpl(this._self, this._then);

  final _PodkuSocketMessage _self;
  final $Res Function(_PodkuSocketMessage) _then;
