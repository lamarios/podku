...
_RemoteCommand _$RemoteCommandFromJson(Map<String, dynamic> json) => _RemoteCommand(
...
Map<String, dynamic> _$RemoteCommandToJson(_RemoteCommand instance) => <String, dynamic>{
