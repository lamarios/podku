...
@useResult
$Res call({
 List<PodcastLight> subscriptions, SearchResult? subscribingTo, dynamic error, StackTrace? stackTrace
});
...
as List<PodcastLight>,subscribingTo: freezed == subscribingTo ? _self.subscribingTo : subscribingTo // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<PodcastLight> subscriptions,  SearchResult? subscribingTo,  dynamic error,  StackTrace? stackTrace)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PodcastState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<PodcastLight> subscriptions,  SearchResult? subscribingTo,  dynamic error,  StackTrace? stackTrace)  $default,) {final _that = this;
switch (_that) {
case _PodcastState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<PodcastLight> subscriptions,  SearchResult? subscribingTo,  dynamic error,  StackTrace? stackTrace)?  $default,) {final _that = this;
switch (_that) {
case _PodcastState() when $default != null:
return $default(_that.subscriptions,_that.subscribingTo,_that.error,_that.stackTrace);case _:
  return null;
...
class _PodcastState implements PodcastState, WithError {
 ...
 final  List<PodcastLight> _subscriptions;
@override@JsonKey() List<PodcastLight> get subscriptions {
