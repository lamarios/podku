...
class _EpisodesEndpoint {
  ...
  _i3.Future<List<_i4.Episode>> getEpisodes(
  ...
  _i3.Future<_i4.Episode?> getEpisode(
    _i1.TestSessionBuilder sessionBuilder,
    _i2.UuidValue id,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Stream<_i5.EpisodeProgress> playbackStream(
    _i1.TestSessionBuilder sessionBuilder,
    _i2.UuidValue player,
  ) {
    var _localTestStreamManager = _i1.TestStreamManager<_i5.EpisodeProgress>();
...
class _PodcastEndpoint {
  ...
  _i3.Future<_i6.Podcast> subscribeToPodcast(
    _i1.TestSessionBuilder sessionBuilder,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'podcast',
            method: 'subscribeToPodcast',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'podcast',
          methodName: 'subscribeToPodcast',
  ...
  _i3.Future<_i6.Podcast> parsePodcast(
    _i1.TestSessionBuilder sessionBuilder,
    _i7.SearchResult result,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
