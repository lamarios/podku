...
-- Indexes
CREATE INDEX "episode_language_idx" ON "episode_transcripts" USING btree ("language", "episodeId");
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('podku', '20260725002818295', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260725002818295', "timestamp" = now();
