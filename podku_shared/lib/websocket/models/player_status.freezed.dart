...
mixin _$PlayerStatus {
 ...
 PlayerInfo? get client; Episode? get episode; int get position; int get duration; double get speed; bool get playing;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,client,episode,position,duration,speed,playing);

@override
String toString() {
  return 'PlayerStatus(client: $client, episode: $episode, position: $position, duration: $duration, speed: $speed, playing: $playing)';
}
...
@useResult
$Res call({
 PlayerInfo? client, Episode? episode, int position, int duration, double speed, bool playing
});
...
/// Create a copy of PlayerStatus
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? client = freezed,Object? episode = freezed,Object? position = null,Object? duration = null,Object? speed = null,Object? playing = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PlayerInfo? client,  Episode? episode,  int position,  int duration,  double speed,  bool playing)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlayerStatus() when $default != null:
return $default(_that.client,_that.episode,_that.position,_that.duration,_that.speed,_that.playing);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PlayerInfo? client,  Episode? episode,  int position,  int duration,  double speed,  bool playing)  $default,) {final _that = this;
switch (_that) {
case _PlayerStatus():
return $default(_that.client,_that.episode,_that.position,_that.duration,_that.speed,_that.playing);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PlayerInfo? client,  Episode? episode,  int position,  int duration,  double speed,  bool playing)?  $default,) {final _that = this;
switch (_that) {
case _PlayerStatus() when $default != null:
return $default(_that.client,_that.episode,_that.position,_that.duration,_that.speed,_that.playing);case _:
  return null;
...
class _PlayerStatus implements PlayerStatus {
  const _PlayerStatus({this.client, required this.episode, required this.position, required this.duration, required this.speed, this.playing = false});
...
/// Create a copy of PlayerStatus
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? client = freezed,Object? episode = freezed,Object? position = null,Object? duration = null,Object? speed = null,Object? playing = null,}) {
