...
sealed class RemoteCommand with _$RemoteCommand {
  const factory RemoteCommand({required CommandType type, Episode? episode, int? position, double? speed}) =
      _RemoteCommand;

  factory RemoteCommand.fromJson(Map<String, Object?> json) => _$RemoteCommandFromJson(json);
}

enum CommandType { play, pause, stop, skipForward, rewind, setEpisode, seek, setSpeed }
