...
class ReconnectableWebSocket {
  ...
  final StreamController<PodkuSocketMessage> controller = StreamController<PodkuSocketMessage>.broadcast();

  Stream<PodkuSocketMessage> get stream => controller.stream;
